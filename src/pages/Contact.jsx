...
function Contact() {
    ...
    return (
        <div className='relative' id='contact'>
            <div className='text-black-200 flex justify-center items-center min-h-screen h-screen py-[60px]'>
                <div className='flex justify-center items-start flex-col max-w-[1000px] w-full h-full'>
                    <div className='relative text-left w-full text-2xl mb-10 md:text-3xl md:mb-8'>
                        <div className='relative flex flex-col md:flex-row justify-between items-center text-left w-full text-2xl mb-10 md:text-3xl md:mb-8'>
                            <div className='min-w-[150px] flex-1 md:min-w-[300px] mb-2 md:mb-0'>
                    ...
                    <div className='contact-info flex justify-center items-center flex-col max-w-[550px] mx-auto mt-auto text-center flex-1'>
